...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"MazeGen.MainPage"))
    {
        return winrt_make_MazeGen_MainPage();
    }

    if (requal(name, L"MazeGen.XamlMetaDataProvider"))
    {
        return winrt_make_MazeGen_XamlMetaDataProvider();
    }
