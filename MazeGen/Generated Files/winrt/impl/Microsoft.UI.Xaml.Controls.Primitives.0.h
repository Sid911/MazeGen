...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Controls::Primitives::IAutomationPropertiesStatics9>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Controls::Primitives::IAutomationPropertiesStatics9> = L"Microsoft.UI.Xaml.Controls.Primitives.IAutomationPropertiesStatics9";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4> = L"Microsoft.UI.Xaml.Controls.Primitives.IPopup4";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Controls::Primitives::IAutomationPropertiesStatics9>{ 0x98FFD442,0xA3F5,0x534C,{ 0x90,0x6D,0x88,0xB7,0x2A,0x78,0x12,0x6B } }; // 98FFD442-A3F5-534C-906D-88B72A78126B
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4>{ 0x1870B836,0xDF2F,0x5FC6,{ 0xA5,0xF2,0x74,0x8E,0xD6,0xCE,0x73,0x21 } }; // 1870B836-DF2F-5FC6-A5F2-748ED6CE7321
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Controls::Primitives::IAutomationPropertiesStatics9>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) KeepInteriorCornersSquareProperty() const;
        WINRT_IMPL_AUTO(void) SetKeepInteriorCornersSquare(winrt::Windows::UI::Xaml::Controls::AutoSuggestBox const& autoSuggestBox, bool value) const;
        WINRT_IMPL_AUTO(bool) GetKeepInteriorCornersSquare(winrt::Windows::UI::Xaml::Controls::AutoSuggestBox const& autoSuggestBox) const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Controls_Primitives_IAutomationPropertiesStatics9
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) ControlTypeProperty() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Automation::Peers::AutomationControlType) GetControlType(winrt::Windows::UI::Xaml::UIElement const& element) const;
        WINRT_IMPL_AUTO(void) SetControlType(winrt::Windows::UI::Xaml::UIElement const& element, winrt::Windows::UI::Xaml::Automation::Peers::AutomationControlType const& value) const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Controls::Primitives::IAutomationPropertiesStatics9>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Controls_Primitives_IAutomationPropertiesStatics9<D>;
    };
    template <typename D>
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) KeepInteriorCornersSquareProperty() const;
        WINRT_IMPL_AUTO(void) SetKeepInteriorCornersSquare(winrt::Windows::UI::Xaml::Controls::ComboBox const& comboBox, bool value) const;
        WINRT_IMPL_AUTO(bool) GetKeepInteriorCornersSquare(winrt::Windows::UI::Xaml::Controls::ComboBox const& comboBox) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) FilterProperty() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) ConversionKindProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) MultiplierProperty() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Thickness) HorizontalOrientationPadding() const;
        WINRT_IMPL_AUTO(void) HorizontalOrientationPadding(winrt::Windows::UI::Xaml::Thickness const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Thickness) VerticalOrientationPadding() const;
        WINRT_IMPL_AUTO(void) VerticalOrientationPadding(winrt::Windows::UI::Xaml::Thickness const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) HorizontalOrientationPaddingProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) VerticalOrientationPaddingProperty() const;
        WINRT_IMPL_AUTO(void) SetHorizontalOrientationMargin(winrt::Windows::UI::Xaml::DependencyObject const& object, winrt::Windows::UI::Xaml::Thickness const& value) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Thickness) GetHorizontalOrientationMargin(winrt::Windows::UI::Xaml::DependencyObject const& object) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) HorizontalOrientationMarginProperty() const;
        WINRT_IMPL_AUTO(void) SetVerticalOrientationMargin(winrt::Windows::UI::Xaml::DependencyObject const& object, winrt::Windows::UI::Xaml::Thickness const& value) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Thickness) GetVerticalOrientationMargin(winrt::Windows::UI::Xaml::DependencyObject const& object) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) VerticalOrientationMarginProperty() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::UIElement) SourceElement() const;
        WINRT_IMPL_AUTO(void) SourceElement(winrt::Windows::UI::Xaml::UIElement const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) SourceElementProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) ReplacementColorProperty() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) IconWidthProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) SmallerIconWidthProperty() const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Controls_Primitives_IPopup4
    {
        ...
        using ActualPlacementChanged_revoker = impl::event_revoker<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4, &impl::abi_t<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4>::remove_ActualPlacementChanged>;
    ...
    template <> struct consume<winrt::Microsoft::UI::Xaml::Controls::Primitives::IPopup4>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Controls_Primitives_IPopup4<D>;
    };
    template <typename D>
    ...
    struct consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollController
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::UIElement) InteractionElement() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::Controls::Orientation) InteractionElementScrollOrientation() const;
        WINRT_IMPL_AUTO(void) SetExpressionAnimationSources(winrt::Windows::UI::Composition::CompositionPropertySet const& propertySet, param::hstring const& minOffsetPropertyName, param::hstring const& maxOffsetPropertyName, param::hstring const& offsetPropertyName, param::hstring const& multiplierPropertyName) const;
        WINRT_IMPL_AUTO(void) SetScrollMode(winrt::Microsoft::UI::Xaml::Controls::ScrollingScrollMode const& scrollMode) const;
        WINRT_IMPL_AUTO(void) SetValues(double minOffset, double maxOffset, double offset, double viewport) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::CompositionAnimation) GetScrollAnimation(int32_t correlationId, winrt::Windows::Foundation::Numerics::float2 const& currentPosition, winrt::Windows::UI::Composition::CompositionAnimation const& defaultAnimation) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) InteractionRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollController, winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollControllerInteractionRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] InteractionRequested_revoker InteractionRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollController, winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollControllerInteractionRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) InteractionRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) InteractionInfoChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollController, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] InteractionInfoChanged_revoker InteractionInfoChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollController, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::PointerPoint) PointerPoint() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollControllerInteractionRequestedEventArgs) CreateInstance(winrt::Windows::UI::Input::PointerPoint const& pointerPoint) const;
    };
