...
namespace winrt::impl
{
    ...
    template <> struct default_interface<winrt::Microsoft::UI::Xaml::XamlTypeInfo::XamlControlsXamlMetaDataProvider>{ using type = winrt::Windows::UI::Xaml::Markup::IXamlMetadataProvider; };
    ...
    {
        WINRT_IMPL_AUTO(void) Initialize() const;
    };
