...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::AcrylicBackgroundSource) BackgroundSource() const;
        WINRT_IMPL_AUTO(void) BackgroundSource(winrt::Microsoft::UI::Xaml::Media::AcrylicBackgroundSource const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::AcrylicBrush) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Media_IRadialGradientBrush
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Point) GradientOrigin() const;
        WINRT_IMPL_AUTO(void) GradientOrigin(winrt::Windows::Foundation::Point const& value) const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IObservableVector<winrt::Windows::UI::Xaml::Media::GradientStop>) GradientStops() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::RadialGradientBrush) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Media_IRadialGradientBrushStatics
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) GradientOriginProperty() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Xaml::DependencyProperty) InterpolationSpaceProperty() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::RevealBackgroundBrush) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::RevealBorderBrush) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::RevealBrush) CreateInstance(winrt::Windows::Foundation::IInspectable const& baseInterface, winrt::Windows::Foundation::IInspectable& innerInterface) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Media_IRevealBrushStatics
    {
        ...
        WINRT_IMPL_AUTO(void) SetState(winrt::Windows::UI::Xaml::UIElement const& element, winrt::Microsoft::UI::Xaml::Media::RevealBrushState const& value) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::RevealBrushState) GetState(winrt::Windows::UI::Xaml::UIElement const& element) const;
    };
